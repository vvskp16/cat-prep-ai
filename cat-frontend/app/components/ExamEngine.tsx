      ...
      <div className="fixed inset-0 z-50 bg-gray-50 flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex flex-1 overflow-hidden">
               ...
               <div className="flex flex-col pb-20">
                  ...
                  {isSubmitted && (
                    <div className="mt-10 space-y-4 border-t border-gray-100 pt-6">
                      ...
                      >
                        {isCurrentlyRevealed ? (
                          <><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" /></svg> Hide Answer & Solution to Reattempt</>
                        ) : (
          ...
          <div className="w-80 bg-gray-50 border-l border-gray-200 shadow-sm shrink-0 flex flex-col p-5 overflow-y-auto">
             <h3 className="font-bold text-gray-700 mb-4 uppercase text-xs tracking-wider">{isSubmitted ? 'Performance Map' : 'Question Palette'}</h3>
        ...
        <div className="fixed inset-0 z-[60] bg-black/60 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-fadeIn">
            ...
            <div className="flex justify-end gap-3 mt-6">
              <button onClick={() => setShowExitModal(false)} className="px-5 py-2.5 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50">Resume Exam</button>
              <button onClick={submitExam} className="px-5 py-2.5 bg-red-600 text-white rounded-lg font-bold hover:bg-red-700 shadow-sm flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
                Yes, Submit
              </button>
            </div>
